...
namespace Epsteam {
    ...
    private:
        ...
        // ¡NUEVO! Aquí guardaremos la referencia al carrito de la tienda
    ...
    public:
        // AHORA RECIBE EL CARRITO COMO PARÁMETRO
    ...
    private:
        ...
        void CargarDatosSimulados() {
            ...
            // Verificamos si ya estaba en el carrito para poner el botón en verde
